        ...
        for step in range(args.start_step, cfg.SOLVER.MAX_ITER):
            ...
            for inner_iter in range(args.iter_size):
                ...
                if (step + 1) % 50 == 0:
                    ...
                    xlsx_name = output_dir.split("/")[1]
                    loss_file = output_dir + "/loc_loss_" + xlsx_name + ".xlsx"
                    ...
                    cls_loss = net_outputs['losses']['loss_cls'].item()
                    loc_loss = net_outputs['losses']['loss_bbox'].item()
                    append_data = {'loc/all': loc_loss / (loc_loss + cls_loss)}
